...
def write_name(
    ...
    location_name = (400, 250)  # Replace with the coordinates you noted. (X, Y)
    # location_course = (400, 350) 
    # location_date = (xxx,yyy) 

    font1 = ImageFont.truetype(os.path.join(base_dir,"assets/fonts/font1.ttf"), 75) 
    # font2 = ImageFont.truetype(os.path.join(base_dir,"assets/fonts/font1.ttf"), 75)
    d.text(location_name, name, fill=text_color, font=font1)
    # d.text(location_course, course, fill=text_color, font=font2)
    # d.text(location_date, date, fill=text_color, font=font2)
